...
public class Ejercicio11B {
	...
	private static final int DIAS_EN_MES_CORTO = 30;
	...
	public static void main(String[] args) {
		...
		if (anio == 0) {
			...
			int diasEnElMes = DIAS_EN_MES_LARGO;

			// Comprobar mes
			switch (mes) {
//			case 1, 3, 5, 7, 8, 10, 12:
//				diasEnElMes = DIAS_EN_MES_LARGO;
//				break;
			case 4, 6, 9, 11:
				diasEnElMes = DIAS_EN_MES_CORTO;
				break;
			case 2:
				// Comprobar 28/29 días
				boolean esBisiesto = ((anio % 4 == 0) && (anio % 100 != 0)) || (anio % 400 == 0);
				diasEnElMes = esBisiesto ? DIAS_FEBRERO_BISIESTO : DIAS_FEBRERO_NORMAL;
				break;
			}

			// Comprobar días en el mes
